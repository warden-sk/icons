...
exports.Sun = exports.Plus = exports.Plane = exports.ChevronRight = exports.ChevronLeft = exports.BookmarkAdd = exports.ArrowRightAlt = void 0;
...
const Plane = ({ className, size = 24, ...$ }) => react_1.default.createElement("svg", { ...$, className: className ? `icon ${className}` : 'icon', height: size, viewBox: "0 0 24 24", width: size, xmlns: "http://www.w3.org/2000/svg" },
    react_1.default.createElement("path", { d: "M13 9V3.5a1.5 1.5 0 0 0-3 0V9l-8 5v2l8-2.5V19l-2 1.5V22l3.5-1 3.5 1v-1.5L13 19v-5.5l8 2.5v-2l-8-5", fill: "currentColor" }));
exports.Plane = Plane;
